            ...
            <tbody>
                ...
                while ($fila = $resultado->fetch_assoc()) {
                    ...
                    <tr>
                        ...
                        <td> <a href="editarlast.php?Id=<?php echo $fila['id']?>"  onclick="return "><i class="fa-solid fa-file-pen" style="color: #10da1e;"></i></a></td>
                        <td> <a href="eliminar.php?Id=<?php echo $fila['id']?>"  onclick="return confirmacion()"><i class="fa-solid fa-trash" style="color: #f20202;"></i></a></td>
